...
folder_path = "/content/drive/MyDrive/Bears_2025_Tracker"
personnel_path = os.path.join(folder_path, "bears_personnel_usage.csv")
offense_path = os.path.join(folder_path, "bears_offensive_analytics.csv")
defense_path = os.path.join(folder_path, "bears_defensive_analytics.csv")
strategy_path = os.path.join(folder_path, "bears_weekly_strategy.csv")
